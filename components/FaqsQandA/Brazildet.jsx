...
const faqSets = {
  visa: [
    {
      question:
        "What are the requirements documents needed to apply for a BRAZIL visa?",
      answer:
    ...
    {
      question: "What is the cost of applying for a Brazil visa?",
      answer:
        " Processing Fee - N300,000 per adult N270,000 per child Visa Fee - $100 Insurance Fee - N30,000 Courier Fee - N30,000",
    },
    {
    ...
    },
    {
      ...
      answer:
        "3 to 12 months depending on the decision of the consular. You can extend the visa when you get to Brazil.",
    },
    {
...
export default function Brazildet() {
