...
const faqSets = {
  visa: [
    {
      question:
        "What are the requirements documents needed to apply for a Hong-Kong visa?",
      answer:
    ...
    {
      question: "What is the cost of applying for a Hong-Kong visa?",
      answer:
...
export default function Kongdet() {
