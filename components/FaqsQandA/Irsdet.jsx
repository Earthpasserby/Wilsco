...
const faqSets = {
  visa: [
    {
      question:
        "What are the requirements documents needed to apply for a Ireland visa?",
      answer:
    ...
    {
      question: "What is the cost of applying for a Ireland visa?",
      answer:
...
export default function Irsdet() {
