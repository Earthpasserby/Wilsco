...
const faqSets = {
  visa: [
    {
      question:
        "What are the requirements documents needed to apply for a AUSTRALIA visa?",
      answer:
    ...
    {
      question: "What is the cost of applying for an Australian visa?",
      answer:
        " Processing Fee - N200,000 per adultN160,000 per child Visa Fee - $150 USD ",
    },
    {
...
export default function Ausdet() {
