...
const faqSets = {
  visa: [
    {
      question:
        "What are the requirements documents needed to apply for a TURKEY visa?",
      answer:
    ...
    {
      question: "What is the cost of applying for a TURKEY visa?",
      answer:
        "Processing Fee - N200,000 per adult N160,000 per child \nVisa Fee- LAGOS– Application & Biometric fee: $220\nMandatory VIP Fee (Lagos submission centre only): $100\nABUJA- Application & Biometric fee: $160\nCourier Services Fee: N15,000",
    },
    {
      question: "How long is the visa processing timeline?",
      answer:
        "It could take 15 working days or more after submission at the embassy. ",
    },
    {
    ...
    },
    {
      ...
      answer:
        "The duration could be from 1 to 3 months based on the discretion of the embassy consulate. ",
    },
    {
...
export default function Turkeydet() {
