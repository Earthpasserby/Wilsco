...
const faqSets = {
  visa: [
    {
      question:
        "What are the requirements documents needed to apply for a Canada visa?",
      answer:
    ...
    {
      question: "What is the cost of applying for a Canada visa?",
      answer:
        "Processing Fee - N200,000 per adult,     N160,000 per child \nVisa Fee - $185 CAD per adult $100 CAD per child (below 12 years)",
    },
    {
      question: "How long is the visa processing timeline?",
      answer:
        "It could take 3 months to 6 months after submission and biometrics is done. This timeline can be changed from time to time depending on the embassy. It can be faster or slower. ",
    },
    {
    ...
    {
      question: "Can I apply if I’m not employed or run a Business?",
