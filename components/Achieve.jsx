          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 pt-10 gap-4">
            <div className="bg-white rounded-2xl px-10">
              <div className="pt-8  mb-8 ">
                <a
                  href="#"
                  className="bg-red-500  text-white px-4 py-2 rounded-4xl"
                >
                  Step 01
                </a>
              </div>
              ...
              <p className="text-[#686868] text-[16px] font-normal mb-8">
                Book a consultation to discover the best study options tailored
                to you.
              </p>
            </div>
            <div className="bg-white rounded-2xl px-10">
              ...
              <p className="text-[#686868] text-[16px] font-normal mb-8">
                Make payment to kick-start your school search and application
                process.
              </p>
            </div>
            <div className="bg-white rounded-2xl px-10">
            ...
            <div className="bg-white rounded-2xl px-10">
              ...
              <p className="text-[#686868] text-[16px] font-normal mb-8">
                Pack your bags—you’re on your way to achieving your dream of
                studying abroad!
              </p>
            </div>
          </div>
